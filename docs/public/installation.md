...
| GATEWAY_SYSTEM_NAME           | string  | no        | `"default-external-gateway"` | Name of the default Gateway resource used for HTTPRoute binding.                                                                                                                                                                                                                                                                                |
| GATEWAY_SYSTEM_NAMESPACE      | string  | no        | `"gateway-system"`           | Namespace where the default Gateway resource is deployed.                                                                                                                                                                                                                                                                                       |
...
| rabbitmq.envoyGateway.parentRefs                          | list    | no        | [`{"name":"default-external-gateway","namespace":"envoy-gateway"}`]                                                     | Defines the Gateway resources that the RabbitMQ HTTPRoute attaches to.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
